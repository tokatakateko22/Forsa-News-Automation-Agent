...
# We use the sync psycopg2 URL here (Alembic runs synchronously).
# DATABASE_URL in .env uses asyncpg; we convert it for Alembic.
raw_url: str = os.environ.get("DATABASE_URL", "")
